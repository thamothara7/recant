...
export const STORY: StoryStep[] = [
  {
    ...
    body:
      "Three AI bots work together and share what they learn. Every card on this board is one memory a bot has saved. An arrow means one memory was built from another. Green ✓ memories are healthy.",
  },
  {
